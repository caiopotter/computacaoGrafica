...
def DrawGLScene():
	...
	glTexCoord2f(0.6667, 1.0); glVertex3f( 1.0,  1.0,  1.0)   
	glTexCoord2f(0.6667, 0.5); glVertex3f(-1.0,  1.0,  1.0)  
	glEnd()

	# Back Face
	glBegin(GL_QUADS)
	glTexCoord2f(0.3333, 0.0); glVertex3f(-1.0, -1.0, -1.0)	
	glTexCoord2f(0.3333, 0.5); glVertex3f(-1.0,  1.0, -1.0)	
	...
	# Top Face
	glBegin(GL_QUADS)
	glTexCoord2f(0.3333, 1.0); glVertex3f(-1.0,  1.0, -1.0)   
	glTexCoord2f(0.3333, 0.5); glVertex3f(-1.0,  1.0,  1.0)	
	glTexCoord2f(0.6667, 0.5); glVertex3f( 1.0,  1.0,  1.0)	
	glTexCoord2f(0.6667, 1.0); glVertex3f( 1.0,  1.0, -1.0)   
	glEnd()
	...
	glTexCoord2f(0.3333, 0.5); glVertex3f( 1.0, -1.0, -1.0)   
	glTexCoord2f(0.3333, 0.0); glVertex3f( 1.0, -1.0,  1.0)   
	glTexCoord2f(0.6667, 0.0); glVertex3f(-1.0, -1.0,  1.0)		
	glEnd()
